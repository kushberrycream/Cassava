...
class pkg_MiniorangeSAMLSSOInstallerScript
{
    ...
    border-color: #545b62;
        ...
        if($PluginType=='ALL')
        {
            ...
            <h4>Change Log</h4>
            <div class="mo-row">Current Version: <?php echo  $PluginVersion; ?>  <a class="mo_boot_btn mo_boot_btn-saml" style="margin-left:15px" href="https://plugins.miniorange.com/joomla-saml-sso-changelog-free"  target="_blank" ><?php echo JText::_('Click here to check change logs'); ?> </a></div>
            <?php
        ...
        ?>
    	<div class="mo-row">
            <a class="mo_boot_btn mo_boot_btn-saml" onClick="window.location.reload();" href="index.php?option=com_miniorange_saml&tab=overview">Start Using miniOrange SAML SP plugin</a>
