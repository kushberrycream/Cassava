...
use _JchOptimizeVendor\Illuminate\Contracts\Container\CircularDependencyException;
...
class Container implements \ArrayAccess, ContainerContract
{
    ...
    {
        return isset($this->instances[$abstract]) || isset($this->bindings[$abstract]['shared']) && \true === $this->bindings[$abstract]['shared'];
    }
     ...
     * @param callable|string $abstract
     *
     * @return null|array|\Closure|string
     */
