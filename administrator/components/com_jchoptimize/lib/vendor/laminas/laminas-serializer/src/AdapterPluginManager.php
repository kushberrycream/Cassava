...
class AdapterPluginManager extends AbstractPluginManager
{
    ...
    public function validate($instance)
    {
        if (!$instance instanceof $this->instanceOf) {
            throw new InvalidServiceException(\sprintf('%s can only create instances of %s; %s is invalid', static::class, $this->instanceOf, \is_object($instance) ? \get_class($instance) : \gettype($instance)));
        }
    }
