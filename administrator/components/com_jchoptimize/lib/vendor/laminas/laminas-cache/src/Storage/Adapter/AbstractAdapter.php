...
abstract class AbstractAdapter implements StorageInterface, PluginAwareInterface
{
    ...
    public function addPlugin(Plugin\PluginInterface $plugin, $priority = 1)
    {
        ...
        if ($registry->contains($plugin)) {
            throw new Exception\LogicException(\sprintf('Plugin of type "%s" already registered', \get_class($plugin)));
        }
    ...
    public function getItems(array $keys)
    {
        ...
        $args = new \ArrayObject(['keys' => &$keys]);

        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalGetItems($args['keys']);
    ...
    public function hasItem($key)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalHasItem($args['key']);
    ...
    public function hasItems(array $keys)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalHasItems($args['keys']);
    ...
    public function getMetadata($key)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalGetMetadata($args['key']);
    ...
    public function getMetadatas(array $keys)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalGetMetadatas($args['keys']);
    ...
    public function setItems(array $keyValuePairs)
    {
        ...
        $args = new \ArrayObject(['keyValuePairs' => &$keyValuePairs]);

        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalSetItems($args['keyValuePairs']);
    ...
    public function addItem($key, $value)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalAddItem($args['key'], $args['value']);
    ...
    public function addItems(array $keyValuePairs)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalAddItems($args['keyValuePairs']);
    ...
    public function replaceItem($key, $value)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalReplaceItem($args['key'], $args['value']);
    ...
    public function replaceItems(array $keyValuePairs)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalReplaceItems($args['keyValuePairs']);
    ...
    public function checkAndSetItem($token, $key, $value)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalCheckAndSetItem($args['token'], $args['key'], $args['value']);
    ...
    public function touchItem($key)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalTouchItem($args['key']);
    ...
    public function touchItems(array $keys)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalTouchItems($args['keys']);
    ...
    public function removeItem($key)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalRemoveItem($args['key']);
    ...
    public function removeItems(array $keys)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalRemoveItems($args['keys']);
    ...
    public function incrementItem($key, $value)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalIncrementItem($args['key'], $args['value']);
    ...
    public function incrementItems(array $keyValuePairs)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalIncrementItems($args['keyValuePairs']);
    ...
    public function decrementItem($key, $value)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalDecrementItem($args['key'], $args['value']);
    ...
    public function decrementItems(array $keyValuePairs)
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalDecrementItems($args['keyValuePairs']);
    ...
    public function getCapabilities()
    {
        ...
        try {
            $eventRs = $this->triggerPre(__FUNCTION__, $args);
            $result = $eventRs->stopped() ? $eventRs->last() : $this->internalGetCapabilities();
    ...
    protected function normalizeKey(&$key)
    {
        $key = (string) $key;
        if ('' === $key) {
            throw new Exception\InvalidArgumentException("An empty key isn't allowed");
        }
        if (($p = $this->getOptions()->getKeyPattern()) && !\preg_match($p, $key)) {
            throw new Exception\InvalidArgumentException("The key '{$key}' doesn't match against pattern '{$p}'");
        }
    }
    ...
    {
        if (!$keys) {
            throw new Exception\InvalidArgumentException("An empty list of keys isn't allowed");
        }
