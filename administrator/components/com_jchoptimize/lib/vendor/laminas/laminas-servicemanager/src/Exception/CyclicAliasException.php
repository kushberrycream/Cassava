...
class CyclicAliasException extends InvalidArgumentException
{
    ...
    private static function printCycle(array $detectedCycle)
    {
        ...
        return \implode(' => ', \array_map(static fn ($cycle): string => '"'.$cycle.'"', $fullCycle));
    }
