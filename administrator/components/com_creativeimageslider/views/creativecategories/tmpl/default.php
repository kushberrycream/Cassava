...
<?php endif;?>
		...
		<table class="table table-striped" id="articleList">
			<thead>
				<tr>
					...
					<th>
						<?php echo JHtml::_('grid.sort', 'COM_CREATIVEIMAGESLIDER_NAME', 'sc.name', $listDirn, $listOrder); ?>
					</th>
			...
			foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'creativecategories.', true, 'cb', $item->publish_up, $item->publish_down); ?>
					</td>
					<td class="nowrap has-context">
						<div class="pull-left">
							<a href="<?php echo JRoute::_('index.php?option=com_creativeimageslider&task=creativecategory.edit&id='.(int) $item->id); ?>">
		...
		<input type="hidden" name="view" value="creativecategories" />
