				...
				<div class="tab-content">
					<div class="tab-pane active" id="details">
						<div class="control-group">
							...
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_POPUP_OPTIONS_LABEL' );?></div>
							...
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_BUTTON_LINK_OPTIONS_LABEL' );?></div>
...
input.colorSelector, .cis_controls textarea {
	border: 1px solid #afafaf;
    color: #5d5d5f;
    border-radius: 5px;
    font-size: 14px;
