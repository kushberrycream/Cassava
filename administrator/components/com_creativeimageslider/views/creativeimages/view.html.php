...
class CreativeimagesliderViewCreativeimages extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        $min_slider_id  = $this->get('creativeMinSliderId');
    	...
    	if(JV == 'j2') {
            ...
            $filter_slider_id = $this->state->get('filter.slider_id');
            $filter_slider_id = $filter_slider_id == 0 ? $min_slider_id : $filter_slider_id;
    		...
    		JHtmlSidebar::addFilter(
                    ...
                    'filter_slider_id',
                    JHtml::_('select.options', $options, 'value', 'text', $filter_slider_id)
            );
    	}
       	$this->addToolbar();
       	if(JV == 'j3')
