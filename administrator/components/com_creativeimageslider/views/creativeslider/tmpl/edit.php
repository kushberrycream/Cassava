				...
				<div class="tab-content">
					<div class="tab-pane active" id="details">
						<div class="control-group">
							<div style="clear: both;margin: 0px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_MAIN_OPTIONS_LABEL' );?></div>
							<?php foreach($this->form->getFieldset() as $field): ?>
								<div class="cis_control_label"><?php echo $field->label;?></div>
								<div class="cis_controls"><?php echo $field->input;?></div>
							<?php endforeach; ?>
						
							<div style="clear: both;height: 8px;width: 100%;"></div>
							...
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_SLIDER_OPTIONS_LABEL' );?></div>
...
<!-- Slider Appearance ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_SLIDER_APPEARANCE_LABEL' );?></div>
...
<!-- OVERLAY ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_OVERLAY_OPTIONS_LABEL' );?></div>
...
<!-- Caption Options ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_CAPTION_OPTIONS_LABEL' );?></div>
...
<!-- Icons Options ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_ICON_OPTIONS_LABEL' );?></div>
...
<!-- Button Options ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_BUTTON_OPTIONS_LABEL' );?></div>
...
<!-- Arrow Options ****************************************************************************************-->
							...
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_ARROW_OPTIONS_LABEL' );?></div>
...
<!-- AutoPlay Options ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_AUTOPLAY_OPTIONS_LABEL' );?></div>
							...
							<div style="display: none">
							<div style="clear: both;height: 8px;width: 100%;"></div>EMPTY OPTION, CAN BE USED LATER
...
<!-- Popup Main Options ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_POPUP_MAIN_OPTIONS_LABEL' );?></div>
...
<!-- Popup AutoPlay Options ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_POPUP_AUTOPLAY_OPTIONS_LABEL' );?></div>
...
<!-- Popup Arrow Options ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_POPUP_ARROW_OPTIONS_LABEL' );?></div>
...
<!-- Popup Image Order Options ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_POPUP_IMAGE_ORDER_LABEL' );?></div>
...
<!-- Popup Icons Options ****************************************************************************************-->
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_POPUP_ICONS_OPTIONS_LABEL' );?></div>
							...
							<div style="clear: both;margin: 15px 0 10px 0px;color: #08c; font-style: italic;font-size: 12px;text-decoration: underline;width: 100%;"><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_CUSTOM_CODE_LABEL' );?></div>
...
.cis_has_slider,.inputbox,.cis_controls select {
	color: #474747;
