...
class com_creativeimagesliderInstallerScript {
    ...
    function install($parent) {
        ...
        @$module_installer->install(dirname(__FILE__).DIRECTORY_SEPARATOR.'modules'.DIRECTORY_SEPARATOR.'module');
        
        // installing plugin
        $plugin_installer = new JInstaller;
        @$plugin_installer->install(dirname(__FILE__).DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'plugin');
    ...
    function update($parent) {
        ...
        $plugin_uninstaller = new JInstaller;
        @$plugin_uninstaller->install(dirname(__FILE__).DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'plugin');
    }
