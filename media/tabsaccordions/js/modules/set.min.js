 ...
 */
'use strict';import{Helper}from'./helper.min.js?1.5.0';import{ButtonScroller}from'./button_scroller.min.js?1.5.0';import{Item}from'./item.min.js?1.5.0';import{Prototypes}from'./prototypes.min.js?1.5.0';export function Set(container,settings){if(!(container instanceof Element)){throw new Error('No button set passed in');}
