 ...
 */
'use strict';import{Button}from'./button.min.js?1.5.0';import{Panel}from'./panel.min.js?1.5.0';import{PageScroller}from'./page_scroller.min.js?1.5.0';export function Item(id,set){this.id=id;this.set=set;const button=this.getButtonByID(id);const panel=this.getPanelByID(id);this.button=button.rlta=new Button(button,this);this.panel=panel.rlta=new Panel(panel,this);}
