 ...
 */
'use strict';import{Helper}from'./modules/helper.min.js?1.5.0';import{Set}from'./modules/set.min.js?1.5.0';(function(){window.RegularLabs=window.RegularLabs||{};RegularLabs.TabsAccordions={init:function(settings){document.querySelectorAll('[data-rlta-element="container"]').forEach(container=>{container.rlta=new Set(container,settings);});},open:function(button,scroll){button=Helper.getButtonByMixed(button);if(!button){return;}
