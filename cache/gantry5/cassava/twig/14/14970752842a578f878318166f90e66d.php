...
class __TwigTemplate_6cd4d2bc6979c897b61800bda5dd136d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"g-totop\">
        ...
        echo ">
            ";
        // line 9
        if (twig_get_attribute($this->env, $this->source, ($context["particle"] ?? null), "icon", [], "any", false, false, false, 9)) {
            echo "<i class=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["particle"] ?? null), "icon", [], "any", false, false, false, 9), "html", null, true);
            echo "\"></i>";
        }
        // line 10
        echo "            ";
        if (twig_get_attribute($this->env, $this->source, ($context["particle"] ?? null), "content", [], "any", false, false, false, 10)) {
            echo twig_get_attribute($this->env, $this->source, ($context["particle"] ?? null), "content", [], "any", false, false, false, 10);
        }
        // line 11
        echo "            ";
...
";
    ...
    {
        return array (  85 => 12,  80 => 11,  75 => 10,  69 => 9,  59 => 8,  53 => 6,  49 => 5,  44 => 1,  42 => 3,  35 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@particles/totop.html.twig", "C:\\MAMP\\htdocs\\cassava.nri.org\\media\\gantry5\\engines\\nucleus\\particles\\totop.html.twig");
    }
}
