...
return [
    ...
    'timestamp' => 1694426655,
    'checksum' => '8b5c473e1b4b81d54d5584c9b229bcf8',
    'files' => [
        'templates/cassava/custom/config/_error' => [
            'index' => [
                'file' => 'templates/cassava/custom/config/_error/index.yaml',
                'modified' => 1693316096
            ],
            'layout' => [
                'file' => 'templates/cassava/custom/config/_error/layout.yaml',
                'modified' => 1693316096
            ]
        ],
    ...
    'data' => [
        'particles' => [
            ...
            'logo' => [
                ...
                'image' => 'gantry-media://images/Artboard 1.webp',
                'text' => '',
                'class' => '',
                'height' => '8rem',
                'svg' => ''
        ...
        'page' => [
            ...
            'assets' => [
                'favicon' => 'gantry-media://images/logos/compass-100trans.png',
                'touchicon' => 'gantry-media://images/logos/NRI-SocialMediaLogo.png',
                'css' => [
            ...
            'head' => [
                'meta' => [
                    0 => [
                        'description' => 'NRI\'s collaborative work on cassava, an important food security crop, has won multiple awards. Their world-leading research addresses key challenges in the cassava value chain.'
                    ],
                    1 => [
                        'og:description' => 'NRI\'s collaborative work on cassava, an important food security crop, has won multiple awards. Their world-leading research addresses key challenges in the cassava value chain.'
                    ],
                    2 => [
                        'og:title' => 'NRI Cassava Programme'
                    ],
                    3 => [
                        'og:type' => 'website'
                    ],
                    4 => [
                        'og:image' => '../images/logos/NRI-Logo_sm.png'
                    ],
                    5 => [
                        'og:url' => 'https://cassava.nri.org'
                    ]
                ],
                'head_bottom' => '',
                'atoms' => [
        ...
        'index' => [
            ...
            'particles' => [
                ...
                'content' => [
                    'system-content-7942' => 'Page Content'
                ],
                'position' => [
                    'position-footer' => 'Footer'
                ],
                'copyright' => [
                    'copyright-1902' => 'Copyright'
                ],
                'mobile-menu' => [
                    'mobile-menu-2625' => 'Mobile-menu'
                ]
            ],
            'inherit' => [
