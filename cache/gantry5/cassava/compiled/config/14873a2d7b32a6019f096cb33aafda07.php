...
return [
    ...
    'timestamp' => 1693823852,
    'checksum' => '1d131cc9c7adfbe3b903b8c3cb90a345',
    'files' => [
        'templates/cassava/custom/config/_body_only' => [
            'index' => [
                'file' => 'templates/cassava/custom/config/_body_only/index.yaml',
                'modified' => 1693315985
            ],
            'layout' => [
                'file' => 'templates/cassava/custom/config/_body_only/layout.yaml',
                'modified' => 1693315985
            ]
        ],
    ...
    'data' => [
        ...
        'index' => [
            ...
            'particles' => [
                'messages' => [
                    'system-messages-8619' => 'System Messages'
                ],
                'content' => [
                    'system-content-5889' => 'Page Content'
                ]
            ],
            'inherit' => [
        ...
        'layout' => [
            ...
            'layout' => [
                '/main/' => [
                    0 => [
                        0 => 'system-messages-8619'
                    ],
                    1 => [
                        0 => 'system-content-5889'
                    ]
                ]
            ],
            'structure' => [
