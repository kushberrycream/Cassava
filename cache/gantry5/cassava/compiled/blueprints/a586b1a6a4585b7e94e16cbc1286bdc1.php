...
return [
    ...
    'timestamp' => 1694422673,
    'checksum' => 'c0981c3c1c41a46b4a3a8504d54f88e3',
    'files' => [
        'templates/cassava/particles' => [
            'particles/sample' => [
                'file' => 'templates/cassava/particles/sample.yaml',
                'modified' => 1693302101
            ]
        ],
        ...
        'templates/cassava/blueprints' => [
            'page' => [
                'file' => 'templates/cassava/blueprints/page.yaml',
                'modified' => 1694422670
            ],
            'styles/accent' => [
                'file' => 'templates/cassava/blueprints/styles/accent.yaml',
                'modified' => 1693302101
            ],
            'styles/base' => [
                'file' => 'templates/cassava/blueprints/styles/base.yaml',
                'modified' => 1693302101
            ],
            'styles/breakpoints' => [
                'file' => 'templates/cassava/blueprints/styles/breakpoints.yaml',
                'modified' => 1693302101
            ],
            'styles/feature' => [
                'file' => 'templates/cassava/blueprints/styles/feature.yaml',
                'modified' => 1693302101
            ],
            'styles/footer' => [
                'file' => 'templates/cassava/blueprints/styles/footer.yaml',
                'modified' => 1693302101
            ],
            'styles/header' => [
                'file' => 'templates/cassava/blueprints/styles/header.yaml',
                'modified' => 1693302101
            ],
            'styles/main' => [
                'file' => 'templates/cassava/blueprints/styles/main.yaml',
                'modified' => 1693302101
            ],
            'styles/menu' => [
                'file' => 'templates/cassava/blueprints/styles/menu.yaml',
                'modified' => 1693302101
            ],
            'styles/navigation' => [
                'file' => 'templates/cassava/blueprints/styles/navigation.yaml',
                'modified' => 1693302101
            ],
            'styles/offcanvas' => [
                'file' => 'templates/cassava/blueprints/styles/offcanvas.yaml',
                'modified' => 1693302101
            ],
            'styles/showcase' => [
                'file' => 'templates/cassava/blueprints/styles/showcase.yaml',
                'modified' => 1693302101
            ],
            'styles/subfeature' => [
                'file' => 'templates/cassava/blueprints/styles/subfeature.yaml',
                'modified' => 1693302101
            ]
        ],
    ...
    'data' => [
        'items' => [
            ...
            'particles.sample.samples.*.id' => [
                ...
                'default' => NULL,
                'name' => 'particles.sample.samples.*.id'
            ],
            ...
            'particles.sample.samples.*.variations' => [
                'type' => 'input.block-variations',
                'label' => 'Variations',
                'name' => 'particles.sample.samples.*.variations'
            ],
            'particles.analytics' => [
                'type' => '_root',
                'form_field' => false,
                ...
                'sample' => [
                    ...
                    'samples' => [
                        '*' => [
                            ...
                            'id' => 'particles.sample.samples.*.id',
                            'class' => 'particles.sample.samples.*.class',
                            'variations' => 'particles.sample.samples.*.variations'
                        ]
                    ]
                ],
                'analytics' => [
