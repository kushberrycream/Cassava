			...
			if(cis_popup_event == 0 || cis_link_event == 0) {
				...
				if(cis_link_event == 0) {
					$wrapper.on(event_type, '.cis_link_icon', function(e) {
						var cis_click_target = parseInt($(this).parents('.cis_row_item_inner').find('.cis_row_item_overlay').data("cis_click_target"));
						var cis_click_url = $(this).parents('.cis_row_item_inner').find('.cis_row_item_overlay').data("cis_click_url");
...
// backlink ///////////////////////////////////////////////////////////////////////////////////////////
		...
		this.cis_make_backlinks = function() {
			...
			$wrapper.mouseleave(function() {
				this.cis_hide_back_canvas($back);
			}.bind(this));
		};
